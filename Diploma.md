...
Першим етапом в виявленні диму є виділення фону. В даному методі використовується статичні методи для виділення фону. Для цього з кожного кадру виділяється статичні частини, які об’єднуються в фон. Після цього, передній план може будти знайденим простим відніманням фону від кадру.
